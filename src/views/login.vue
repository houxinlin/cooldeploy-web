<template>
  <div class="login-container">
    <div class="login-form" :rules="loginRules" ref="loginFormRef">
      ...
      <!-- 登录按钮 -->
      <el-button type="primary" style="width: 100%;     margin-top: 19px;" :loading="loading" @click="handleLogin">确定</el-button>
    </div>
  </div>
</template>
